...
## How To Invoke a Private Transaction

After deploying the above token contract on Wanchain, in the Wanchain console, you can invoke private transactions according to following process:
...
**2. Buy stamp for private token transaction**
...
**3. Get stamp mix set for ring signature**
...
**8. Generate token private transaction data**
